# seubarriga_interface_tests_cypress
Automação dos testes de interface site [barrigareact.wcaquino.me](https://barrigareact.wcaquino.me/) utilizando Cypress, Node.js e Javascript
...
``` bash
git clone https://github.com/DinoSaulo/seubarriga_interface_tests_cypress.git
```
...
5. Clicar em "frontend.cy.js"

## Testes

Atualmente esse projeto possui 12 testes, todos eles estão no arquvo [frontend.cy.js](./cypress/e2e/seubarriga/frontend.cy.js):

![switch_de_testes](/cypress/videos/frontend.cy.js.gif "Switch de testes")
